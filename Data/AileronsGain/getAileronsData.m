    ...
    F_flap1 = forces1.*(flapLever/(leverage1*2));
    %% Experiment 2
    % engine 80
    ...
    F_flap2 = forces2.*(flapLever/(leverage1*2));
    ...
    F_flap3 = forces3.*(flapLever/(leverage1*2));
    %% Experiment 4
    % engine 90
    % akku: nach #3
    % Hebelarm: 0.53m achse war 0.045 über schwerpunkt -->
    ...
    F_flap4 = forces4.*(flapLever/(leverage1*2));
    %% Experiment 5
    % engine 95
    % akku: nach #4
    % Hebelarm: 0.53m achse war 0.045 über schwerpunkt -->
    ...
    F_flap5 = forces5.*(flapLever/(leverage1*2));
